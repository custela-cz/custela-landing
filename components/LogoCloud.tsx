...
export default function LogoCloud() {
  return (
    <section className="py-12 md:py-16 border-y border-white/[0.05] bg-black relative overflow-hidden">
      <AnimateIn variant="fade" duration={0.8}>
        ...
        <div className="relative">
          ...
          <div className="flex animate-marquee">
            {/* First set */}
            <div className="flex items-center gap-16 md:gap-24 shrink-0 px-12">
              <LogoItem>
                <GoogleAdsLogo />
              </LogoItem>
              <LogoItem>
...
function LogoItem({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center justify-center opacity-30 hover:opacity-60 transition-opacity duration-500">
      {children}
    </div>
  )
}
...
function GoogleAdsLogo() {
  return (
    <div className="flex items-center gap-2.5 text-white/80">
      ...
      <span className="font-medium text-sm whitespace-nowrap">Google Ads</span>
    </div>
  )
}
...
function MetaLogo() {
  return (
    <div className="flex items-center gap-2.5 text-white/80">
      ...
      <span className="font-medium text-sm whitespace-nowrap">Meta Ads</span>
    </div>
  )
}
...
function SklikLogo() {
  return (
    <div className="flex items-center gap-2.5 text-white/80">
      ...
      <span className="font-medium text-sm whitespace-nowrap">Sklik</span>
    </div>
  )
}
...
function AnalyticsLogo() {
  return (
    <div className="flex items-center gap-2.5 text-white/80">
      ...
      <span className="font-medium text-sm whitespace-nowrap">Analytics</span>
    </div>
  )
}
